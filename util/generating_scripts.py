...
if __name__ == '__main__':
    ...
    data_file='WAVZ_SMX_Version_0.71.xlsx'
    ...
    key_type = input("enter key_type: BKEY_CALL     REG_BKEY_PROCESS    REG_BKEY_DOMAIN REG_BKEY    STREAM  REG_BMAP    REG_BMAP_DOMAIN EXEC_SRCI CORE_KEY_COL_REG   REG_CORE_PROCESS   HIST_REG  " )
    ...
    match key_type:
        ...
        case "REG_BKEY_PROCESS": #System".lower():
            ...
            print(script)
            print(type(script))
            with open('BKEY_REG_PROCESS_output.SQL', mode='wt', encoding='utf-8') as myfile:
                for l in script:
                    myfile.write('\n'.join(l))
                    myfile.write('\n\n')
        ...
        case "REG_BKEY_DOMAIN" : #Stream".lower():
           ...
           with open('BKEY_REG_DOMAIN_script_output.SQL', mode='wt', encoding='utf-8') as myfile:
                for l in script:
                    print(l)
                    myfile.write('\n'.join(l))
                    myfile.write('\n\n')
        ...
        case "REG_BKEY" :# STG tables".lower():
            ...
            with open('BKEY_REG_script_output.SQL', mode='wt', encoding='utf-8') as myfile:
                for l in script:
                    myfile.write('\n'.join(l))
                    myfile.write('\n\n')
        ...
        case "STREAM" :# STG tables".lower():
            ...
            with open('STREAM_REG_script_output.SQL', mode='wt', encoding='utf-8') as myfile:
                for l in script:
                    myfile.write('\n'.join(l))
                    myfile.write('\n\n')
        ...
        case "REG_BMAP" :# STG tables".lower():
            ...
            with open('BMAP_REG_script_output.SQL', mode='wt', encoding='utf-8') as myfile:
                for l in script:
                    myfile.write('\n'.join(l))
                    myfile.write('\n\n')
        ...
        case "REG_BMAP_DOMAIN" :# STG tables".lower():
            ...
            with open('BMAP_DOMAIN_REG_script_output.SQL', mode='wt', encoding='utf-8') as myfile:
                for l in script:
                    myfile.write('\n'.join(l))
                    myfile.write('\n\n')
        ...
        case "EXEC_SRCI" :# STG tables".lower():
            ...
            with open('SRCI_EXEC_script_output.SQL', mode='wt', encoding='utf-8') as myfile:
                for l in script:
                    myfile.write('\n'.join(l))
                    myfile.write('\n\n')
        ...
        case "CORE_KEY_COL_REG" :# STG tables".lower():
            ...
            print(script_dict)
            with open("CORE_KEY_COL_REG_script_output.txt", "w") as file:
        ...
        case "REG_CORE_PROCESS" :# core tables
            ...
            with open('CORE_REG_PROCESS_script_output.SQL', mode='wt', encoding='utf-8') as myfile:
                for l in script:
                    myfile.write('\n'.join(l))
                    myfile.write('\n\n')
        ...
        case "HIST_REG" :# STG tables".lower():
            ...
            with open('CORE_HIST_REG_script_output.SQL', mode='wt', encoding='utf-8') as myfile:
                for l in script:
                    myfile.write('\n'.join(l))
                    myfile.write('\n\n')
